...
export class TranscriptionError extends Error {
  constructor({ code, message, action, cause, phase, details }) {
    super(message);
...
export const isTranscriptionError = (error) =>
  error instanceof TranscriptionError || error?.name === "TranscriptionError";

export const formatTranscriptionError = (error) => {
...
export function classifyTranscriptionError(error, context = {}) {
