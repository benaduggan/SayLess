...
import type { EditorContentState } from "./context/contentStateTypes";
...
interface EditorDevHudProps {
  setContentState: Dispatch<SetStateAction<EditorContentState>>;
  contentStateRef: MutableRefObject<EditorContentState>;
  lastDownloadInfo?: LastDownloadInfo | null;
  lastRecordingBackend?: string | null;
}

interface EditorDevAction {
  label: string;
  fn(): void;
}

const DevHUD: React.FC<EditorDevHudProps> = ({
  setContentState,
  contentStateRef,
  lastDownloadInfo,
