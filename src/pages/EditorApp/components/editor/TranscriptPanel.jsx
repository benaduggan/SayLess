...
const TranscriptPanel = ({ variant = "drawer" }) => {
  ...
  const onSuggestionSeek = (suggestion) => {
...
const suggestionsList = { display: "flex", flexDirection: "column", gap: 6 };
const suggestionRow = {
  display: "grid",
...
const chaptersList = { display: "flex", flexDirection: "column", gap: 4 };
