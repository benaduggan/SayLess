...
// Styles
import styles from "../../styles/edit/_Switch.module.css";
  ...
  return (
    <form>
      <div className={styles.SwitchRow}>
        <label className={styles.Label} htmlFor="replaceAudio" style={{ paddingRight: 15 }}>
      ...
      <div className={styles.SwitchRow}>
        <label className={styles.Label} htmlFor="loopAudio" style={{ paddingRight: 15 }}>
          Loop added audio
        </label>
        <S.Root
          id="loopAudio"
