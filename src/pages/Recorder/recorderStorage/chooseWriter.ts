 ...
 */
import { IdbChunkWriter } from "./idbChunkWriter.ts";
import { OpfsChunkWriter } from "./opfs/opfsChunkWriter.ts";
import type { ChunkWriter } from "./chunkWriterInterface.ts";

const isOpfsSyncSupported = (): boolean => {
  try {
