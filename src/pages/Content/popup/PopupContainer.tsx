...
const assertLocalExtensionUrl = (url: string): string => {
...
const PopupContainer = (props: {
  ...
  const recordTabRef = useRef<HTMLButtonElement | null>(null);
  ...
  useLayoutEffect(() => {
    function setPopupPosition(_e?: UIEvent) {
  ...
  const handleDragStart = (_e: unknown, _d: unknown) => {
  ...
  const handleDrop = (e: unknown, d: { x: number; y: number }) => {
    positionRef.current = { x: d.x, y: d.y };
      ...
      >
        ...
        >
          ...
          {contentState.settingsOpen && (
            <div className="HelpSection" onClick={openLocalHelpPage}>
