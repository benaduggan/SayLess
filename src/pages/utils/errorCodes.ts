...
export type RecordingErrorCode =
  | typeof REC_START_PERM
  | typeof REC_START_STREAM
  | typeof REC_START_CODEC
  | typeof REC_START_REGION
  | typeof REC_START_TAB
  | typeof REC_START_TIMEOUT
  | typeof REC_START_CANCEL
  | typeof REC_START_NOT_READY
  | typeof REC_START_NO_STREAM_MSG
  | typeof REC_RUN_STREAM_END
  | typeof REC_RUN_MEMORY
  | typeof REC_STOP_CHUNKS
  | typeof REC_STOP_EDITOR
  | typeof DRV_AUTH
  | typeof DRV_FOLDER
  | typeof DRV_UPLOAD
  | typeof UNKNOWN
...
const qualifyUnknown = (errorType: unknown): RecordingErrorCode => {
...
export const makeRecordingAttemptId = (): string => {
