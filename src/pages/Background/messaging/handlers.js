...
const normalizeClickActivityEvent = ({
  ...
  return {
    ...
    x,
    y,
    xRatio: viewportWidth > 0 ? clamp01(x / viewportWidth) : null,
    yRatio: viewportHeight > 0 ? clamp01(y / viewportHeight) : null,
...
const shouldShowReviewPrompt = async () => {
  try {
    ...
    if (
      ...
      recent(s.recordingDegradedMode) ||
...
export const setupHandlers = () => {
  ...
  const openLocalDiagnostics = async (message = {}, source = "support") => {
    const request = {
      source,
