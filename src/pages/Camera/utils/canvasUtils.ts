...
export const initializeCanvases = (): {
  ...
  offScreenCanvasContext: Canvas2DContext | null;
} => {
...
export const setupCanvasContexts = (
  ...
  canvasContext: Canvas2DContext | null;
  bottomCanvasContext: Canvas2DContext | null;
} => {
...
export const resizeCanvases = (
  ...
  effectImg: (CanvasImageSource & { width: number; height: number }) | null,
  canvasRef: MutableRef<HTMLCanvasElement>,
  bottomCanvasRef: MutableRef<HTMLCanvasElement>,
  bottomCanvasContextRef: MutableRef<Canvas2DContext>,
): boolean => {
...
export const captureVideoFrame = (
  ...
  canvasRef: MutableRef<HTMLCanvasElement>,
  canvasContextRef: MutableRef<Canvas2DContext>,
): ImageData | null => {
...
export const clearCanvases = (canvasRefs: {
  ...
  offScreenCanvasContextRef: MutableRef<Canvas2DContext>;
  bottomCanvasRef: MutableRef<HTMLCanvasElement>;
  bottomCanvasContextRef: MutableRef<Canvas2DContext>;
}): void => {
  const {
