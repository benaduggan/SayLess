...
export interface ExportPlan {
  keptSegments: TimeRange[];
  outputMutes: TimeRange[];
 ...
 */
export function outputToSource(plan: ExportPlan, outputTime: number): number {
