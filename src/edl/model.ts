...
export type EditKind = "delete" | "mute";
...
export function createEdl(duration: number, opts: { id?: string } = {}): Edl {
...
export function removeEdit(edl: Edl, id: string): Edl {
...
// `compose()` (see compose.ts) is the single place that turns any of this into
