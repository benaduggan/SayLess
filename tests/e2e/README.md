...
| `run-editor-layout.cjs`                | Editor layout smoke: bundles production Tailwind/native CSS into a real Chrome page and verifies the video player, timeline, and independently scrollable transcript pane remain visible and usable across desktop, short desktop, tablet, and phone viewports.                                                                                                                                                                                                | no      |
